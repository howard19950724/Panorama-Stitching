...
def MultipleStitch(Images, Trans, fileName='../results/pano.jpg'):
    ...
    #cause we change the mode of picture, maybe we cannot write the mode as jpg from RGBA
    #cause RGBA is 4 channel, but jpg just 3 so that we need to change the mode from RGBA to RGB
